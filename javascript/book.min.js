...
this.getBottomHeight()},getWidth:function(){return this.getLeftWidth()+this.getRightWidth()}};window.templeteName="envato";
window.templateArea={getLeftWidth:function(){return 0},getRightWidth:function(){return MiniStyle.isMini()||!bookConfig.ToolBarVisible?0:isPC()?48:phoneTemplateArea.getTopHeight()},getTopHeight:function(){return MiniStyle.isMini()||NeatStyle.isNeat()||!bookConfig.ToolBarVisible?0:isPC()?0:phoneTemplateArea.getTopHeight()},getBottomHeight:function(){return MiniStyle.isMini()?0:NeatStyle.isNeat()?40:bookConfig.ToolBarVisible?isPC()?50:phoneTemplateArea.getBottomHeight():0},getHeight:function(){return this.getTopHeight()+
